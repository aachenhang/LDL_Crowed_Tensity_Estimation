...
parser.add_argument('--data', type=str, required=False, default='Mall')
...
data_source = join(dirname(__file__), 'data', 'MallDB', 'Ratio0.4')
...
if __name__ == '__main__':
    ...
    plt.title("Mall: MAE vs Iter(best=%.4f)" % (mae.min()))
