...
parser.add_argument('--data', type=str, required=False, default='UCSD')
...
data_source = join(dirname(__file__), '..', 'data', 'UCSDDB', 'Ratio0.4')
...
if __name__ == '__main__':
    ...
    plt.title("UCSD: MAE vs Iter(best=%.4f)" % (mae.min()))
