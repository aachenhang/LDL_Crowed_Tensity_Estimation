...
if __name__ == '__main__':
    ...
    make_lmdb(db_path, img_list[0:600]+img_list[1400:2000], 'image')
    db_path = abspath(join(base_dir, 'Ratio' + str(args.ratio), 'test-count'))
    #make_lmdb(db_path, img_list[NTrain:NTrain + NTest], 'count')
    make_lmdb(db_path, img_list[0:600]+img_list[1400:2000], 'count')
